...
namespace assignment1.Controllers
{
    ...
    public class q8 : ControllerBase
    {
        ...
        //->5 Small @ $25.50 = $127.50; 10 Large @ $40.50 = $405.00; Subtotal = $532.50; Tax = $69.23 HST; Total = $601.72
        //curl -H "Content-Type: application/x-www-form-urlencoded" -d "Small=10&Large=5" https://localhost:7214/api/q8/squashfellows
        //->10 Small @ $25.50 = $255.00; 5 Large @ $40.50 = $202.50; Subtotal = $457.50; Tax = $59.48 HST; Total = $516.97
        //</example>

        //actually we can type /// to get below form
        /// <summary>
        /// 
        /// </summary>
        ...
        public string Squashfellows([FromForm] int Small, [FromForm] int Large)
        {
            ...
            string tax = (Math.Round((subtotal * 0.13),2)).ToString("C", CultureInfo.CreateSpecificCulture("en-CA"));
            string total = (Math.Round((subtotal *1.13),2)).ToString("C", CultureInfo.CreateSpecificCulture("en-CA"));
            //Math.Round to not less 0.01
            ...
            return $"{Small} Small @ $25.50 = {small_string}; {Large} Large @ $40.50 = {large_string}; Subtotal = {subtotal_string}; Tax = {tax} HST; Total = {total}";
        }
    }
}
